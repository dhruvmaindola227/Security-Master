...
//         <Tab label={<span style={{ color: "#02111B" }}>Put Schedule</span>}></Tab>
//         <Tab label={<span style={{ color: "#02111B" }}>Pricing and Analytics</span>}></Tab>
//         <Tab label={<span style={{ color: "#02111B" }}>Call Schedule</span>}></Tab>
...
React.useEffect(() => {
  ...
  return (
    <>
      ...
      <TableViewData tabledata={bondData}/>
    </>
  );
};
